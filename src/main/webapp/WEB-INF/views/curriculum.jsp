                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="input-group search-area" style="margin: auto">
                            ...
                            <input type="text" class="form-control" placeholder="输入课程.."
                                   style="color: #0f0f0f;text-align: left" id="inputtext">
                            <span class="input-group-text"><a href="javascript:void(0)"><i
                                    class="flaticon-381-search-2"></i></a></span>
                            <button>
                                <span><a href="/InsertDetails_page">添加课程信息＋</a></span>
                            </button>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    <thead>
                                    <tr>
                                        <th style="width:80px;"><strong>课程编号</strong></th>
                                        <th><strong>课程名称</strong></th>
                                        <th><strong>授课老师编号</strong></th>
                                        <th><strong>上课时间</strong></th>
                                        <th><strong>上课地点</strong></th>
                                        <th><strong>周数</strong></th>
                                        <th><strong>课程类型</strong></th>
...
<script type="text/javascript">
    $(function () {
        ...
        function getAllstudent() {
            $.ajax({
                type: "get",
                url: "/findAllCurriculm",
                success: function (data) {
                    var test = "";
                    $.each(data, function (index, value) {
                        test += "<tr>" +
                            "<td><strong>" + value.cid + "</strong></td>" +
                            "<td>" + value.cname + "</td>" +
                            "<td>" + value.tid + "</td>" +
                            "<td>" + value.cclasstime + "</td>" +
                            "<td><span class=\"badge light badge-success\">" + value.cclassadress + "</span></td>" +
                            "<td>" + value.cmoth + "</td>" +
                            "<td>" + value.cclasstype + "</td>" +
                            "<td>" + value.cfraction + "</td>" +
                            "<td>" +
                            "<div class=\"dropdown\">" +
                            ...
                            "<a class=\"dropdown-item\" href=\"/selectAllByCid?cid=" + value.cid + "\">修改</a>" +
                            "<a class=\"dropdown-item\" href=\"/delCurriculmByCid?cid=" + value.cid + "\">删除</a>" +
                            "</div>" +
                            "</div>" +
                            "</td>" +
                            "</tr>"
