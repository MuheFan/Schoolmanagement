                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">修改课程信息</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form method="post" action="/UpdateCurriculm">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#time").find("option:contains('${curriculm.cclasstime}')").prop("selected", "selected");
        $("#address").find("option:contains('${curriculm.cclassadress}')").prop("selected", "selected");
        $("#Weeks").find("option:contains('${curriculm.cmoth}')").prop("selected", "selected");
        $("#type").find("option:contains('${curriculm.cclasstype}')").prop("selected", "selected");
        $("#Affiliated").find("option:contains('${curriculm.cdepartment}')").prop("selected", "selected");
        $("#credit").find("option:contains('${curriculm.cfraction}')").prop("selected", "selected");
        ...
        function addteachername() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#teachername").find("option:contains('${curriculm.tid}')").prop("selected", "selected");
                }
