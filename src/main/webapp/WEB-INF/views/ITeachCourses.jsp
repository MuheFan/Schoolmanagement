                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        test += "<tr>" +
                            ...
                            "<a class=\"dropdown-item\" href=\"/findfraction?cid=" + value.cid + "\">成绩</a>" +
                            "</div>" +
                            "</div>" +
                            "</td>" +
                            "</tr>"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    <thead>
                                    <tr>
                                        <th style="width:80px;"><strong>课程号</strong></th>
