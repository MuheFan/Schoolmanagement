                            ...
                            <div class="table-responsive">
                                <form method="post" action="/addStudent">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="radio" value="男" name="ssex" style="margin-left: 5%"> <span
                                            style=" margin-left: 5px; margin-top: 2px;font-size: 15px;">男</span>
                                        <input type="radio" name="ssex" value="女" style="margin-left: 10%"> <span
                                            style=" margin-left: 5px; margin-top: 2px;font-size: 15px;">女</span>
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">出生年月日</label>
                                        <input type="date" style="margin-left: 5%" name="birthtime" id="birthtime">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">入学时间</label>
                                        <input type="date" style="margin-left: 5%" name="sschooltime" id="sschooltime">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
