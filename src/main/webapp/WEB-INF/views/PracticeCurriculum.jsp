    ...
    <script type="text/javascript">
        $(function () {
            ...
            function getAllstudent() {
                $.ajax({
                    type: "post",
                    url: "/selectRepairedCurriculm",
                    success: function (data) {
                        var test = "";
                        $.each(data, function (index, value) {
                            test += "<tr>" +
                                "<td><strong>" + value.curriculm.cid + "</strong></td>" +
                                "<td>" + value.curriculm.cname + "</td>" +
                                "<td>" + value.curriculm.tid + "</td>" +
                                "<td>" + value.curriculm.cclasstime + "</td>" +
                                "<td><span class=\"badge light badge-success\">" + value.curriculm.cclassadress + "</span></td>" +
                                "<td>" + value.curriculm.cmoth + "</td>" +
                                "<td>" + value.curriculm.cclasstype + "</td>" +
                                "<td>" + value.curriculm.cfraction + "</td>" +
                                "<td style=color: red>" + value.fracion + "</td>" +
                                "</tr>"
                        })
                        $("#tbody").html(test)
                    }
