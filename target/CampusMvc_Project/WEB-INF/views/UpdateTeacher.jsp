        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">${user.utype}</a></li>
                </ol>
            </div>
            <!-- row -->
                            ...
                            <div class="table-responsive">
                                <form method="post" action="/UpdateTeacher">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="radio" value="男" name="tsex" style="margin-left: 5%"
                                        <c:if test="${teacher.tsex=='男'}"> checked </c:if> > > <span
                                            style=" margin-left: 5px; margin-top: 2px;font-size: 15px;">男</span>
                                        <input type="radio" name="tsex" value="女" style="margin-left: 10%"
                                        <c:if test="${teacher.tsex=='女'}"> checked </c:if> > > <span
                                            style=" margin-left: 5px; margin-top: 2px;font-size: 15px;">女</span>
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">出生年月日</label>
                                        <input type="date" style="margin-left: 5%" value="${teacher.tbirthtime}"
                                               name="tbirthtime">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" style="margin-left: 5%" value="${teacher.tentrydate}"
                                               name="tentrydate">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                    ...
                                    <button style="margin-left: 5%"> 重置</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#Weeks").find("option:contains('${teacher.teducation}')").prop("selected", "selected");
        $("#title").find("option:contains('${teacher.ttitle}')").prop("selected", "selected");
    })
