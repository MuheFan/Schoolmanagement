                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">打分</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form method="post" action="/UpdateAchievementById">
                                    <div class="input-group">
                                        <label class="label">课程名字</label>
                                        <input autocomplete="off" name="cname" id="id" class="input" type="text"
                                               disabled value="${findAchievementById.curriculm.cname}">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">学号</label>
                                        <input autocomplete="off" name="student.sid" id="sid" class="input" type="text"
                                               disabled value="${findAchievementById.student.sid}">
                                        <div></div>
                                    </div>

                                    <div class="input-group">
                                        <label class="label">姓名</label>
                                        <input autocomplete="off" name="sname" id="title" class="input" type="text"
                                               disabled value="${findAchievementById.student.sname}">
                                        <div></div>
                                    </div>

                                    <div class="input-group">
                                        <label class="label">打分</label>
                                        <input autocomplete="off" name="fracion" id="Affiliated " class="input"
                                               type="text" value="${findAchievementById.fracion}">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <input name="aid" value="${findAchievementById.aid}" style="visibility: hidden">
                                    </div>
