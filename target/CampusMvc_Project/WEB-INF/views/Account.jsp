        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">账号密码与重置</a></li>
                </ol>
            </div>
            <!-- row -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">帐号(非管理员帐号)</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="输入帐号"
                                                       id="uaccounts">
                                                <label class="col-sm-3 col-form-label" id="messg"></label>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
