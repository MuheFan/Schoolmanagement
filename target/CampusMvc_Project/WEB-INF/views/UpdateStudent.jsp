                            ...
                            <div class="table-responsive">
                                <form method="post" action="/UpdateStudent">
                                    <div class="input-group">
                                        ...
                                        <input autocomplete="off" name="sid" id="id" class="input" type="text"
                                               value="${student.sid}">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">姓名</label>
                                        <input autocomplete="off" name="sname" id="name" class="input" type="text"
                                               value="${student.sname}">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">性别</label>
                                        <input type="radio" value="男" name="ssex" style="margin-left: 5%"
                                        <c:if test="${student.ssex=='男'}"> checked </c:if> > <span
                                            style=" margin-left: 5px; margin-top: 2px;font-size: 15px;">男</span>
                                        <input type="radio" name="ssex" value="女" style="margin-left: 10%"
                                        <c:if test="${student.ssex=='女'}"> checked </c:if> > <span
                                            style=" margin-left: 5px; margin-top: 2px;font-size: 15px;">女</span>
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">出生年月日</label>
                                        <input type="date" style="margin-left: 5%" value="${student.birthtime}"
                                               name="birthtime" id="birthtime">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">入学时间</label>
                                        <input type="date" style="margin-left: 5%" value="${student.sschooltime}"
                                               name="sschooltime" id="sschooltime">
                                        <div></div>
                                    </div>
                                    <div class="input-group">
                                        <label class="label">所属院系</label>
                                        <input autocomplete="off" name="sdepartment" id="sdepartment" class="input"
                                               type="select" value="${student.sdepartment}">
                                        <div></div>
                                    </div>
