    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow ai-icon" href="${pageContext.request.contextPath}/page-login_Page">
                    <i class="flaticon-050-info"></i>
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">学生管理</a></li>
                </ol>
            </div>
            <!-- row -->
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="input-group search-area" style="margin: auto">
                            ...
                            <button>
                                <span><a href="/InsertSudent_page">添加学生信息＋</a></span>
                            </button>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    <thead>
                                    <tr>
                                        <th style="width:80px;"><strong>学号</strong></th>
                                        <th><strong>姓名</strong></th>
                                        <th><strong>性别</strong></th>
                                        <th><strong>出生年份</strong></th>
                                        <th><strong>入学时间</strong></th>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        test += " <tr>\n" +
                            " <td><strong>" + value.sid + "</strong></td>" +
                            " <td>" + value.sname + "</td>" +
                            " <td>" + value.ssex + "</td>" +
                            "  <td>" + value.birthtime + "</td>" +
                            " <td>" + value.sschooltime + "</td>" +
                            " <td>" + value.sdepartment + "</td>" +
                            "  <td>" +
                            "<div class=\"dropdown\">" +
                            ...
                            "<a class=\"dropdown-item\" href=\"/selectAllBySid?sid=" + value.sid + "\">修改</a>" +
                            "<a class=\"dropdown-item\" href=\"/delStudentBySid?sid=" + value.sid + "\">删除</a>" +
                            "</div>" +
                            "</div>" +
                            "</td>" +
                            "</tr>"
